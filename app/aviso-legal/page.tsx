...
export default function AvisoLegalPage() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
          ...
          <div className="space-y-10 text-dkv-gray leading-relaxed text-justify">
            ...
            <section>
              ...
              <ul className="mt-4 space-y-2 border-l-4 border-dkv-green pl-6 py-2 bg-gray-50">
                ...
                <li><strong>NIF:</strong> [INTRODUCIR NIF AQUÍ]</li>
                <li><strong>Domicilio:</strong> Av. César Augusto, 33, 50004 Zaragoza (España).</li>
                <li><strong>Email:</strong> [INTRODUCIR EMAIL AQUÍ]</li>
            ...
            <section>
              ...
              <div className="mt-4 p-4 border border-dkv-gray/10 rounded-lg">
                ...
                <p className="mt-2 text-sm text-dkv-gray/70">
                  Verificable en la sede electrónica de la DGSFP (www.dgsfp.mineco.es).
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p>
                Este sitio web facilita información sobre el seguro <strong>DKV Dentisalud Élite</strong>. El acceso implica la aceptación de las presentes condiciones de uso.
              </p>
            </section>

            {/* 5. Responsabilidad Médica (Cláusula Crítica) */}
            <section className="bg-amber-50 p-6 rounded-xl border border-amber-100">
              ...
              <p className="text-amber-900 italic text-sm md:text-base">
                "El Titular actúa exclusivamente como mediador de seguros. La prestación de los servicios odontológicos corre a cargo de los profesionales y clínicas de la Red Dental de DKV. El mediador no es responsable de los actos médicos ni de la praxis de los facultativos."
              </p>
            </section>
            ...
            <section className="pb-12">
              ...
              <p>
                Para quejas o reclamaciones, el usuario dispone del Servicio de Atención al Cliente de DKV Seguros:
              </p>
      ...
      {/* Reutilización del Footer Corporativo */}
      <FooterLegal />
    </div>
  );
}
...
const tocData = [
  {
    level: { id: "nivel-1", number: "Convencional", title: "Ortodoncia Fija Metálica" },
    treatments: [
      { id: "metalicos", name: "Brackets Metálicos Convencionales", price: "Desde 298 €" },
      { id: "autoligables", name: "Brackets Metálicos Autoligables", price: "Desde 298 €" }
    ]
  },
  {
    level: { id: "nivel-2", number: "Estética", title: "Ortodoncia Fija de Cristal de Zafiro" },
    treatments: [
      { id: "zafiro", name: "Ortodoncia Fija Estética (Brackets de Zafiro)", price: "Desde 298 €" },
      { id: "autoligables-zafiro", name: "Brackets de Cristal de Zafiro Autoligables", price: "Desde 298 €" }
    ]
  },
  {
    level: { id: "nivel-3", number: "Invisible", title: "Tratamientos Ortodóncicos Estéticos" },
    treatments: [
      { id: "lingual", name: "Ortodoncia Fija Lingual (100% Invisible)", price: "Desde 298 €" },
      { id: "invisalign", name: "Alineadores Transparentes / Invisalign", price: "3.210 €" },
      { id: "carillas", name: "Carillas Estéticas y Diseño Digital de Sonrisa", price: "Desde 396 €" }
    ]
  },
  {
    level: { id: "nivel-4", number: "Procedimientos", title: "Procedimientos Transversales Obligatorios" },
    treatments: [
      { id: "diagnostico", name: "Diagnóstico Preciso y Retención Final" }
    ]
  },
  {
    level: { id: "nivel-5", number: "Aparatología", title: "Aparatología Auxiliar y Odontopediatría" },
    treatments: [
      { id: "auxiliares", name: "Auxiliares Biomecánicos y Removibles" },
      { id: "odontopediatria", name: "Odontopediatría y Crecimiento (Niños)" }
    ]
  }
];
...
// --- Componentes de UI ---
const TreatmentRow = ({ id, name, price, image, imageAlt, secondaryImage, secondaryImageAlt, titleTag = "h2", children }: { id: string, name: string, price?: string, image?: string, imageAlt?: string, secondaryImage?: string, 
  secondaryImageAlt?: string, titleTag?: "h2" | "p" | "h3", children: React.ReactNode }) => {
  const Tag = titleTag; 
  ...
  return (
    <div id={id} className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-md border border-dkv-gray-border/80 hover:shadow-xl hover:border-dkv-green/40 hover:-translate-y-1 transition-all duration-300 group scroll-mt-[130px] md:scroll-mt-[150px]">
      ...
      {/* 📸 IMAGEN PRINCIPAL (Antes del texto) */}
      {image && (
      ...
      {/* 📸 IMAGEN SECUNDARIA / DETALLE (Después del texto) ⚡️ NUEVO */}
      {secondaryImage && (
    ...
    <div className="min-h-screen bg-white font-fsme text-dkv-gray selection:bg-dkv-green selection:text-white pb-32">
      ...
      <main className="pt-[30px] md:pt-[110px] lg:pt-[130px]">
        ...
        <TreatmentsHero 
          ...
          description={[
            "Nunca se es demasiado mayor para beneficiarse de un tratamiento de ortodoncia o de estética dental.",
          ]}
        />
        ...
        <section className="bg-dkv-gray-border/30">
          <div className="container mx-auto px-4 max-w-4xl flow-root">
            ...
            <ScrollReveal>
              <LevelTitle 
                id="nivel-1"
                number="Ortodoncia convencional" 
                title="Ortodoncia Fija Metálica" 
              />
            </ScrollReveal>
            ...
            <ScrollReveal>
              <LevelTitle 
                id="nivel-2"
                number="Ortodoncia estética" 
                title="Ortodoncia Fija de Cristal de Zafiro" 
              />
            </ScrollReveal>
            ...
            <div className="space-y-6">
              ...
              <ScrollReveal delay={100} direction="left">
                <TreatmentRow 
                      id="autoligables-zafiro" 
                      name="Brackets de Cristal de Zafiro Autoligables" 
                ...
                >
                  <p>Una evolución tecnológica del bracket de cristal de zafiro que prescinde de ataduras.</p>
                  <p><strong>Por qué elegirlo:</strong> Poseen una pequeña "compuerta" que sujeta el arco, eliminando las gomitas elásticas. Esto reduce la fricción, aplica fuerzas más biológicas y facilita enormemente el cepillado diario.</p>
                  <div className="bg-dkv-gray-light/30 rounded-2xl p-5 border border-dkv-gray-border mt-4">
                    <ul className="space-y-4">
                      <li className="flex flex-col md:flex-row md:justify-between items-start md:items-center pb-3 border-b border-dkv-gray-border/50">
            ...
            <ScrollReveal>
              <LevelTitle 
                id="nivel-3"
                number="Ortodoncia Invisible" 
                title="Tratamientos Ortodóncidos Esteticos Estrella" 
              />
            </ScrollReveal>
            ...
            <div className="space-y-6">
                ...
                <TreatmentRow 
                  ...
                  <div className="bg-dkv-gray-light/30 rounded-2xl p-5 border border-dkv-gray-border mt-4">
                    <ul className="space-y-4">
                      ...
                      <li className="flex flex-col md:flex-row md:justify-between items-start md:items-center">
                        <span className="font-bold text-dkv-gray">Suplemento técnica lingual (por maxilar)</span>
              ...
              <ScrollReveal delay={100} direction="left">
                <TreatmentRow 
                    ...
                    image="/images/tratamientos/estetica-carilla.png"
                  >

    ...
    <section className="relative pt-16 pb-8 px-safe-x md:px-6 container mx-auto">
      <div className="max-w-4xl relative">
        <div className="relative pl-8 md:pl-10 pb-8 pr-4">
          ...
          {/* ✅ OPTIMIZACIÓN: Todo el bloque decorativo oculto para accesibilidad */}
          ...
          <div className="relative z-20 space-y-5 pt-1">
            ...
            <div className="min-h-[130px] md:min-h-[180px] lg:min-h-[220px] flex flex-col justify-start">
              <h1 className="font-lemon text-4xl md:text-5xl lg:text-6xl text-dkv-green-dark leading-[1.1] tracking-tight text-left">
                {h1.dark} <br />
